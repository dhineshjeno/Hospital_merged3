  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Add consultation notes">
      ...
      <div className="grid grid-cols-2 gap-2 mb-4">
        ...
        <Input label="BP Systolic" value={bpSystolic} onChange={setBpSystolic} type="number" placeholder="120" />
        <Input label="BP Diastolic" value={bpDiastolic} onChange={setBpDiastolic} type="number" placeholder="80" />
      ...
      <div className="mb-4 p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg">
        <p className="text-xs text-amber-800 dark:text-amber-300">
          <strong>Note:</strong> Prescriptions are added from the consultation record after saving.
        </p>
      </div>
